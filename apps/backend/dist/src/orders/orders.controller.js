...
let OrdersController = class OrdersController {
    ...
    async findUserOrders(userId, currentUserId) {
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Submit a new order' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get details of an order' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get orders of a user' }),
...
__decorate([
    ...
    __param(2, (0, common_1.Body)('trackingNumber')),
    __metadata("design:type", Function),
